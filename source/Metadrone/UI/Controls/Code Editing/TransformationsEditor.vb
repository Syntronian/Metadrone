Namespace UI
    ...
    Public Class TransformationsEditor
        ...
        Public Sub New()
            ...
            Try
                Me.txtBox = New txtBox(Metadrone.UI.txtBox.HighlightModes.Transformations)
        ...
        Private Sub TransformationsEditor_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            'Set focus, etc
