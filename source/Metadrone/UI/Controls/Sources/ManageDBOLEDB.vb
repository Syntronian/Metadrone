Namespace UI
    ...
    Friend Class ManageDBOLEDB
        ...
        Private Sub TestConn()
            Dim conn As New PluginInterface.Sources.OleDb("", Me.txtConnectionString.Text)
            conn.TestConnection()
        End Sub
...
#Region "Properties"
        ...
        Public Property ColumnSchemaGeneric() As Boolean Implements PluginInterface.Sources.IManageSource.ColumnSchemaGeneric
            Get
                Return Me.rbColumnDefault.Checked
            End Get
            Set(ByVal value As Boolean)
                Me.rbColumnDefault.Checked = value
                Me.rbColumnQuery.Checked = Not value
            End Set
        End Property
...
#Region "Events"
        ...
        Private Sub rbMeta_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rbApproachSingle.CheckedChanged, _
                                                                                                              ...
                                                                                                              rbTableQuery.CheckedChanged, _
                                                                                                              rbColumnDefault.CheckedChanged, _
                                                                                                              rbColumnQuery.CheckedChanged
            ...
            Else
                ...
                If Me.rbTableQuery.Checked Or Me.rbColumnQuery.Checked Then
                    Me.splitTableColumn.Visible = True
                    Me.splitTableColumn.Panel1Collapsed = Not Me.rbTableQuery.Checked
                    Me.splitTableColumn.Panel2Collapsed = Not Me.rbColumnQuery.Checked
                Else
                    Me.splitTableColumn.Visible = False
                End If

                If Not Me.rbTableQuery.Checked Then Me.txtTableSchemaQuery.Text = ""
                If Not Me.rbColumnQuery.Checked Then Me.txtColumnSchemaQuery.Text = ""

                If Me.rbColumnQuery.Checked Then
                    Me.grpColumnSchema.Height = 140
                    Me.lblTableName.Visible = True
...
#Region "Query Testing"
        ...
        Private Sub TestQuery()
            ...
            Try
                ...
                Dim dt As New PluginInterface.Sources.OleDb("", Me.txtConnectionString.Text)
